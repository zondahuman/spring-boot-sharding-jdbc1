 ...
 * 
 */
public class SingleKeyModuleDatabaseShardingAlgorithm implements com.dangdang.ddframe.rdb.sharding.api.strategy.database.SingleKeyDatabaseShardingAlgorithm<Integer> {
